...
echo "" >> ./kuberenetes-cluster-information-output
echo "The cluster nodes information short form, retrieved by kubectl get nodes, is:" >> ./kuberenetes-cluster-information-output
...
echo "The cluster services information short form, retrieved by kubectl get services, is:" >> ./kuberenetes-cluster-information-output
kubectl get services >> ./kuberenetes-cluster-information-output

echo "" >> ./kuberenetes-cluster-information-output
echo "The cluster deployments information short form, retrieved by kubectl get deployments, is:" >> ./kuberenetes-cluster-information-output
kubectl get deployments >> ./kuberenetes-cluster-information-output

echo "" >> ./kuberenetes-cluster-information-output
echo "The cluster pods information short form, retrieved by kubectl get pods, is:" >> ./kuberenetes-cluster-information-output
kubectl get pods >> ./kuberenetes-cluster-information-output

echo "" >> ./kuberenetes-cluster-information-output
echo "The cluster nodes information long form, retrieved by kubectl describe nodes, is:" >> ./kuberenetes-cluster-information-output
kubectl describe nodes >> ./kuberenetes-cluster-information-output

echo "" >> ./kuberenetes-cluster-information-output
echo "The pyflaskapp-service Node PORT number, mapped 8080 internally to 32001 externally," >> ./kuberenetes-cluster-information-output
echo "is used after the IP address listed above in the browswer to bring up the app." >> ./kuberenetes-cluster-information-output
echo "The cluster services information long form, retrieved by kubectl describe services, is:" >> ./kuberenetes-cluster-information-output
kubectl describe services >> ./kuberenetes-cluster-information-output

echo "" >> ./kuberenetes-cluster-information-output
echo "The cluster deployments information long form, retrieved by kubectl describe deployments, is:" >> ./kuberenetes-cluster-information-output
kubectl describe deployments >> ./kuberenetes-cluster-information-output

echo "" >> ./kuberenetes-cluster-information-output
echo "The cluster pods information long form, retrieved by kubectl dsescribe pods, is:" >> ./kuberenetes-cluster-information-output
